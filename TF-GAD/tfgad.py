...
if __name__ == '__main__':
    ...
    configs = {
            ...
            # 社交网络: 重结构 eta小，结构秩(k_s)根据规模和密度调整
            'weibo':     {'k_a': 10, 'k_s': 50,  'eta': 10,  'feature_key': 'feature', 'reported_auc': None, 'reported_auprc': None},
            'amazon':    {'k_a': 10, 'k_s': 100, 'eta': 1,   'feature_key': 'feature', 'reported_auc': None, 'reported_auprc': None},
            'tsocial':   {'k_a': 10, 'k_s': 200, 'eta': 1,   'feature_key': 'feature', 'reported_auc': None, 'reported_auprc': None},
            'yelp':      {'k_a': 10, 'k_s': 100, 'eta': 1,   'feature_key': 'feature', 'reported_auc': None, 'reported_auprc': None},
    
            # 金融/交易网络: 侧重属性 (大eta)，结构相对简单 (小k_s)
            'tfinance':  {'k_a': 20, 'k_s': 20,  'eta': 500, 'feature_key': 'feature', 'reported_auc': None, 'reported_auprc': None},
            'dgraphfin': {'k_a': 20, 'k_s': 20,  'eta': 500, 'feature_key': 'feature', 'reported_auc': None, 'reported_auprc': None},
            'elliptic':  {'k_a': 20, 'k_s': 20,  'eta': 500, 'feature_key': 'feature', 'reported_auc': None, 'reported_auprc': None},
